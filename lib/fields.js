...
function createFieldMaps(renames, toFns, fromFns) {
  const to = Object.assign({}, renames)
  const from = {}
  ...
  return {
    renames: renames,
    to: Object.assign(to, toFns),
    from: Object.assign(from, fromFns)
  }
}
...
function mapFields(data, map) {
  ...
  for (field in data) {
    ...
    if (!mappedField) {
      ...
      Object.assign(ret, mappedField(value))
    }
  }
...
maps.page = createFieldMaps(
  {
    author: /* int */ 'wp_author_id',
    categories: /* struct */ 'categories' /* array */,
    // commentStatus: /* string */ "comment_status",
    customFields: /* array */ 'custom_fields',
    // dateCr: /* datetime */ "post_date",
    description: /* string */ 'description',
    excerpt: /* string */ 'excerpt',
    // format: /* string */"post_format",
    id: /* string */ 'page_id' /* readonly */,
    link: /* string */ 'link' /* readonly */,
    // modified: /* datetime */ "post_modified",
    // menuOrder: /* int */ "menu_order",
    // name: /* string */ "post_name",
    pageTemplate: /* string */ 'wp_page_template',
    parent: /* int */ 'wp_page_parent_id',
    // password: /* string */ "post_password",
    // pingStatus: /* string */ "ping_status",
    status: /* string */ 'page_status',
    // sticky: /* bool */ "sticky",
    // categoryNames: /* struct */ "category_names",
    title: /* string */ 'title'
  },
  {},
  {}
